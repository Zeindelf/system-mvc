{include file="email/partials/style-start.tpl"}
	...
	<p><a
		...
		href="{$smarty.const.BASE_URL}/password/reset/{$data.emailHash}{$data.delimiterHash}{$data.uriHash}">Recuperar Senha</a>
	</p>

	<p>Ou copie e cole o link abaixo no seu navegador:</p>
	<p style="font-family: sans-serif; background: #f1f1f1; display: inline; padding: 4px;">
		{$smarty.const.BASE_URL}/password/reset/{$data.emailHash}{$data.delimiterHash}{$data.uriHash}
	</p>

	<p style="color: seagreen; font-weight: bold;">Este link é válido pelas próximas {$smarty.const.TOKEN_EXPIRE/60} horas.</p>

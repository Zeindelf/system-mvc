...
function content_576af0eb54a9d0_76286558 ($_smarty_tpl) {
...
<?php $_smarty_tpl->tpl_vars['email'] = new Smarty_Variable(Session::get('userSession.email'), null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'email', 0);
$_smarty_tpl->tpl_vars['firstname'] = new Smarty_Variable(Session::get('userSession.firstname'), null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'firstname', 0);
$_smarty_tpl->tpl_vars['lastname'] = new Smarty_Variable(Session::get('userSession.lastname'), null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'lastname', 0);?>
...
">
		...
		<div class="form__field">
			...
			<input type="text" name="firstname" id="firstname" value="<?php echo (($tmp = @smarty_modifier_capitalize($_smarty_tpl->tpl_vars['firstname']->value))===null||$tmp==='' ? null : $tmp);?>
">
		</div><!-- /.form__field -->

		<div class="form__field">
			<label for="lastname">Informe seu sobrenome</label>
			<input type="text" name="lastname" id="lastname" value="<?php echo (($tmp = @smarty_modifier_capitalize($_smarty_tpl->tpl_vars['lastname']->value))===null||$tmp==='' ? null : $tmp);?>
">
		</div><!-- /.form__field -->
